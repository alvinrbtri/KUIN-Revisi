    ...
    <div class="container-fluid">
        <div class="row mt-4">
            <div class="col-md d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex">
                    <a href="{{ url('/essay/review/' . $quiz->quiz_id) }}" class="btn btn-warning me-2" style="font-size: 12px">Review</a>
                    <a href="{{ url('/essay/create_essay/' . $quiz->quiz_id) }}" class="btn btn-info me-2" style="font-size: 12px">Create Essay</a>
        ...
        <div class="row mt-2" style="row-gap: 20px">
            ...
            <div class="col-md-2 text-decoration-none">
                <div class="card">
                    <a href="{{ '/essay/detail/' . $question->quiz_id . '/' . $question->essay_id }}" class="text-decoration-none card-body d-flex flex-column justify-content-center align-items-center" style="color: navy;">
                        <p style="letter-spacing: 2px; font-weight: 500">SOAL</p>
                        <h1 style="font-weight: 700">{{ $loop->iteration }}</h1>
                    </a>
                    <div class="card-footer d-flex justify-content-center align-items-center">
                        <p class="text-center mb-0">Poin: {{ $question->essay_poin }}</p>
                    </div>
                </div>
            </div>
            @endforeach
