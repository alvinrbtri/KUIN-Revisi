            ...
            <div class="col-md">
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        ...
                        <button class="mt-3 btn btn-secondary" @if(auth()->user()->level == 'mahasiswa' || auth()->user()->level == 'dosen' )  id="close_window" @else onclick="history.back();" @endif>
                            Keluar
                        </button>
                    </div>
                </div>
