            ...
            <a href="{{ url('/learning/detail_modul/'.$item->modul_id) }}" class="col-md-4" style="text-decoration: none;">
                <div class="card">
                 <div class="card-body p-0 bg-danger" style="height: 25vh;">
                     <img src="{{ asset('storage/images/'.$item->matkul->image) }}" title="{{ $item->nama_modul }}" style="width: 100%; height: 100%;" alt="modul_image">
                 </div>
                 <div class="card-footer d-flex flex-column justify-content-between" style="height: 25vh; overflow-y: auto">
                   <div class="">
