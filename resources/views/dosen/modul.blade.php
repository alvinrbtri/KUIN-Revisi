                        ...
                        <form action="/learning/create_modul" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="modal-body" style="overflow-y: auto">
                              ...
                              <div class="col-md-12 mt-3 px-0">
                                ...
                                <input type="text" required name="nama_modul" id="nama_modul" class="form-control" placeholder="ex. Algoritma dan Pemrograman">
                              </div>

                              <div class="col-md-12 mt-3 px-0">
                                <label for="file_modul" class="mb-0">File:</label>
                                <input type="file" required name="file_modul" accept=".pdf, .docx, .doc" id="file_modul" class="form-control" placeholder="ex. Algoritma dan Pemrograman">
                              </div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                      <div style="height: 70px; width: 50px;">
                                        <img src="{{ asset('storage/images/'.$data->matkul->image) }}" class="rounded" style="width: 100%; height: 100%; object-fit: contain;" alt="">
                                      </div>
                                  ...
                                  <td>
                                    <a href="{{ asset('storage/documents/'.$data->file_modul) }}" target="_blank">
                                      <i class="fa fa-eye text-success" style="font-size: 12px"> lihat modul</i>
                                    </a>
                                  </td>
                                  <td>
                                    {{ $data->deskripsi }}
                                  ...
                                  <td>
                                    ...
                                    <a href="{{ route('modul_video', ['id' => $data->modul_id]) }}" class="btn">
                                      <i class="fa fa-plus text-info" style="font-size: 12px"> tambah video</i>
                                    </a>
                                    
                                    <button class="btn" data-toggle="modal" data-target="{{ '#hapus' . $data->modul_id }}">
                                      ...
                                      <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                  ...
                                                  <form action="{{ url('/learning/delete_modul_video/'.$data->modul_id) }}" method="POST">
                                                  @csrf
                                    ...
                                    <div class="modal-dialog modal-md modal-dialog-centered">
                                      <div class="modal-content">
                                        <div class="modal-header" style="background: orange">
                                          ...
                                          <form action="{{'/learning/update_modul/'.$data->modul_id}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body" style="overflow-y: auto">
                                                <div class="col-md-12 mt-1 px-0">
                                                  <label for="matkul_id" class="mb-0">Mata Kuliah:</label>
                                                ...
                                                <div class="col-md-12 mt-3 px-0">
                                                  <label for="nama_modul" class="mb-0">Nama Modul:</label>
                                                  <input type="text" required name="nama_modul" id="nama_modul" class="form-control" placeholder="ex. Algoritma dan Pemrograman" value="{{ $data->nama_modul }}">
                                                </div>
                
                                                <div class="col-md-12 mt-3 px-0">
                                                  <label for="file_modul" class="mb-0">File:</label>
                                                  <input type="file" name="file_modul" accept=".pdf, .docx, .doc" id="file_modul" class="form-control" placeholder="ex. Algoritma dan Pemrograman">
                                                </div>
           ...
           @foreach ($modul as $item)
            ...
            <div class="card col-md-4 d-flex align-items-stretch">
                <div class="card-body p-0 bg-danger" style="height: 150px;">
                    <img src="{{ asset('storage/images/'.$item->matkul->image) }}" title="{{ $item->nama_modul }}" style="width: 100%; height: 100%; object-fit: cover;" alt="modul_image">
                </div>
